...
export const metadata: Metadata = {
  ...
  title: {
    absolute: ' Government part-time Jobs', //Option 2 overrides the title in layout.tsx
  },
  description:
    'If you are looking for Government jobs online, you can browse through our job board to find the latest opportunities in this flexible and rewarding field.   ',
  keywords: 'Government Jobs Online. online positions',
};
export default function myPage() {
  return (
    <main className="content-grid">
      {/* <h1>Government part-time Jobs</h1>
      <p>
        ...
        <div className="hero-content flex-col lg:flex-row mx-auto items-start py-12">
          ...
          <div className="">
            <p className="px-7 mb-4 mt-1">
              Seek all part-time gov jobs through Australia’s best job board.
            ...
            <p className="px-7 md:flex hidden">
              ...
              environments, and the overall growth of the Government landscape
