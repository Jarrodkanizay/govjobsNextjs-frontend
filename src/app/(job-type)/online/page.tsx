...
export const metadata: Metadata = {
  ...
  title: {
    absolute: '  Government Executive Jobs', //Option 2 overrides the title in layout.tsx
  },
  description:
        ...
        <div className="hero-content flex-col lg:flex-row mx-auto items-start py-12">
          ...
          <div className="">
            <p className="px-7 mb-4 mt-1">
              Seek all online gov jobs through Australia’s No.1 job board.
              Whether you’re a student, graduate, or professional. Engaging in
              Government online jobs, particularly in higher education, involves a
            ...
            <p className="px-7 md:flex hidden">
              ...
              the Government landscape while simultaneously expanding their
