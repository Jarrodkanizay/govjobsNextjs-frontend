  ...
  <div className="featured-company" aria-hidden="false">
    <Link href={link}>
        ...
        <div className="panel panel-default featured-company__panel">
          <div className="panel-body featured-company__panel-body text-center">
...
export default function Home() {
  return (
    <div className="search-results search-results__companies featured-companies text-center clearfix">
