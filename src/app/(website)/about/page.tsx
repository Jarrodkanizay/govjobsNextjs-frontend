          ...
          <div className="hero-content flex-col lg:flex-row gap-8 ">
            ...
            <div>
              <h1 className="text-4xl">
                GovJobs is your #1 Destination for all your Gov Recruitment
                needs, Career Advancement and Networking
              </h1>
      ...
      <div className="container my-16 grid grid-cols-1 md:grid-cols-2 md:col-span-2 gap-20 px-8 sm:px-32">
        ...
        <div className="card bg-slate-50 changed-css shadow-xl">
          ...
          <div className="card-body">
            ...
            <p>
              Are you looking for your dream role? Then search all Gov jobs now.
            </p>
            <div className="card-actions justify-end">
        ...
        <div className="container prose">
          ...
          <div className="prose text mt-8 ">
            ...
            <p>
              ...
              country and worldwide. At GovJobs, we are more than just a job
              board; we are a dedicated platform committed to shaping the future
              of higher education by facilitating seamless connections between
              Gov talent and leading institutions worldwide.
            </p>
            <h4>Who We Are</h4>
            <p>
              Founded by a team of seasoned professionals with over 30 years of
              expertise in Gov job recruitment advertising, GovJobs was born out
              of a collective frustration with the inefficiencies and lack of
              transparency in the traditional Gov job market.
            </p>
            <blockquote>
            ...
            <p>
              ...
              further. GovJobs is your trusted companion, offering an extensive
              range of opportunities in <span className="uni-jobs">uni</span>
              jobs, Gov Jobs, faculty, research, staff, and professional roles.
            </p>
            <p>
              ...
              communicate effortlessly with employers, making your Gov career
              aspirations a reality.
            </p>
            <h5>For Employers</h5>
            <p>
              Are you an institution seeking top-tier Gov talent? GovJobs
              provides you with a cost-effective, user-friendly platform to
              showcase your <span className="uni-jobs">uni</span>
              jobs, Gov Jobs, and to a global talent pool. With over 10,000
              active job listings and a network of 500 partner institutions
              across 50 countries, we connect you with the brightest minds in
              academia.
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                education. GovJobs is committed to supporting the Gov community
                at all levels.
              </li>
            </ul>
            ...
            <p>
              ...
              dream Gov job or hire the best Gov talent. We are dedicated to
              providing the most comprehensive and up-to-date information,
              advanced and user-friendly tools, and professional, personalized
              service.
            </p>
            <h4>Join the GovJobs Community</h4>
            <p>
              Whether you're a job seeker or an employer, GovJobs invites you to
              join our vibrant community. Explore the possibilities, discover
              opportunities for student jobs on campus, Gov jobs, and and
              contribute to the advancement of academia.
            </p>
            <p>
              We hope your experience with GovJobs is productive and inspiring.
              Your Gov journey begins here.
            </p>
            <p>
              Indeed, jobs can be found everywhere, but our commitment to Gov
              excellence and staff positions, along with our unbeatable customer
              service, will provide you with an experience that simply is not
              available anywhere else. If you want to seek jobs in higher ed we
              are the number one place online. Try us today.
            </p>
            <p>
              {' '}
            ...
            <p>
              <Link href="/terms-of-use/" className="link link-aj">
                Terms & Conditions
              </Link>
            </p>
            <p>
